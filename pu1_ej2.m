...
%% hcanald
[n,h]= hcanald(726176);
stemCompleto([n(1) n(end) -1.5 1.5],'n','Amplitud','Respuesta impulsional del sistema',18,'r-',1.5,n,h);
...
h_y2=salida_2(deltaK(t));
stemCompleto([0 60845 -1 1],'t','Amplitud','h_{y2}[n]',20,'r-',1.5,t, h_y2);
...
h_y3=salida_3(deltaK(t));
stemCompleto([0 60845 -1 1],'t','Amplitud','h_{y3}[n]',20,'r-',1.5,t, h_y3);
