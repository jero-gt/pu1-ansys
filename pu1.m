...
plot_MF([-0.5 0.5 0 110], [-0.5 0.5 -4 4], 's', "X(e^{j2\pis})",25,'m-',1.5,s,X);
...
%plot_comp_MF4x4([-0.5 0.5 0 1.5] ,[-0.5 0.5 -3 3],'s','H1(e^{j2\pis})',25,'m-',1.5, s, H1, H1_v);
plot_comp_MF([-0.5 0.5 0 1.5], [-0.5 0.5 -4 4], 's', "H1(e^{j2\pis})",25,3.5,s,H1, H1_v);
isequal(H1, H1_v)
...
[Y1,~]=TFTD(y1,n);
plot_MF( [-0.5 0.5 0 110],[-0.5 0.5 -4 4], "s",'Y_1(e^{j2\pis})',25,'m-',1.5,s,Y1);
...
%plot_comp_MF4x4([-0.5 0.5 0 1.5] ,[-0.5 0.5 -3 3],'s','H2(e^{j2\pis})',25,'m-',1.5, s, H2, H2_v);
plot_comp_MF([-0.5 0.5 0 1.5], [-0.5 0.5 -4 4], 's', "H_2(e^{j2\pis})",25,3.5,s,H2, H2_v);
isequal(H2, H2_v)


y2=s2(x);
stemCompleto([n(1) n(end) -0.4 0.4],'n','Amplitud','y_2[n]',25,'m.-',1.5,n,y2);

[Y2,~]=TFTD(y2,n);
plot_MF( [-0.5 0.5 0 11],[-0.5 0.5 -4 4], "s",'Y_2(e^{j2\pis})',25,'m-',1.5,s,Y2);
...
%plot_comp_MF4x4([-0.5 0.5 0 1.5] ,[-0.5 0.5 -3 3],'s','H3(e^{j2\pis})',25,'m-',1.5, s, H3, H3_v);
plot_comp_MF([-0.5 0.5 0 1.5], [-0.5 0.5 -4 4], 's', "H3(e^{j2\pis})",25,3.5,s,H3, H3_v);
isequal(H3, H3_v)
error = (H3 - H3_v)./H3 .*100;figure();stem(s,error,'filled');


y3=s3(x);
stemCompleto([n(1) n(end) (min(y3)-1) (max(y3)+1)],'n','Amplitud','y_3[n]',1,'m.-',1.5,n,y3);

[Y3,~]=TFTD(y3,n);
plot_MF([-0.5 0.5 0 max(abs(Y3))],[-0.5 0.5 -4 4], "s",'Y_3(e^{j2\pis})',25,'m-',1.5,s,Y3);
...
[H4_v, ~] = TFTD(h4_v,n);
%plot_comp_MF4x4([-0.5 0.5 0 1.5] ,[-0.5 0.5 -3 3],'s','H4(e^{j2\pis})',25,'m-',1.5, s, H4, H4_v);
plot_comp_MF([-0.5 0.5 0 1.5], [-0.5 0.5 -4 4], 's', "H4(e^{j2\pis})",25,3.5,s,H4, H4_v);
isequal(H4, H4_v)
...
y4=s4(x);
stemCompleto([n(1) n(end) -0.3 0.3],'n','Amplitud','y_4[n]',25,'m.-',1.5,n,y4);

[Y4,~]=TFTD(y4,n);
plot_MF([-0.5 0.5 0 max(abs(Y4))],[-0.5 0.5 -4 4], "s",'Y_4(e^{j2\pis})',25,'m-',1.5,s,Y4);
